<template>
  <section id="about" class="about">
    ...
    <p>Languages et technologies que j'ai pu utiliser jusqu'à présent</p>
    ...
    <p class="caption">
      (L'assemblage des icones provient de
      <a
        href="https://urskill.erickpaoletti.fr"
        target="_blank"
        rel="noopener noreferrer"
        >urskill.erickpaoletti.fr</a
      >)
    </p>
  </section>
</template>
